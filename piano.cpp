...
void Piano::initialize() {
  ...
  this->addNote(*new Note(21, &board1, 0, 0, 255));
  this->addNote(*new Note(22, &board1, 1, 0, 255));
  this->addNote(*new Note(23, &board1, 2, 0, 255));
  this->addNote(*new Note(24, &board1, 3, 0, 255));
  this->addNote(*new Note(25, &board1, 4, 0, 255));
  this->addNote(*new Note(26, &board1, 5, 0, 255));
  this->addNote(*new Note(27, &board1, 6, 0, 255));
  this->addNote(*new Note(28, &board1, 7, 0, 255));
  this->addNote(*new Note(29, &board1, 8, 0, 255));
  this->addNote(*new Note(30, &board1, 9, 0, 255));
  this->addNote(*new Note(31, &board1, 10, 0, 255));
  this->addNote(*new Note(32, &board1, 11, 0, 255));
  this->addNote(*new Note(33, &board1, 12, 0, 255));
  this->addNote(*new Note(34, &board1, 13, 0, 255));
  this->addNote(*new Note(35, &board1, 14, 0, 255));
